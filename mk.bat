...
c:\SDK\ps2dev\gcc\ee\bin\ee-ld -O0 startup.o main.o pg.o -M -Ttext 8900000 -q -o out > main.map
c:\SDK\ps2dev\share\outpatch
c:\SDK\ps2dev\share\elf2pbp outp "GB File Selector"
pause
copy /y EBOOT.PBP E:\PSP\GAME\GBFileSelector
