...
#define TARGETPATH "ms0:/PSP/GAME/RIN/ROM.GB"
...
void CopyExecute(void) {
	...
	pgFillvram(0);
	mh_print(0,0,"コピーしています",0xFFFF,0,0);
	pgScreenFlipV();

	fd1 = sceIoOpen(target,O_RDONLY);
	fd2 = sceIoOpen(TARGETPATH,O_WRONLY | O_CREAT | O_TRUNC);
	while(1) {
